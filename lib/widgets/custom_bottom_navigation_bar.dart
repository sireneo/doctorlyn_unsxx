    ...
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 10),
        ...
        decoration: BoxDecoration(
          color: Color(0xFFFFD500), //color navigatorbarbuton
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: isActive? BoxDecoration(
          color: Colors.lightBlueAccent, //color intem menubarbuton
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            isActive? Text(title,style: TextStyle(fontWeight: FontWeight.w600,color: Color(0xff057163),fontSize: 16),) : SizedBox(width: 0,)
          ],
        ),
      ),
    );
